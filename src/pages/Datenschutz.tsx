      ...
      <div className="max-w-3xl mx-auto px-6 py-14">
        ...
        >
          ...
          <p className="text-[#4a5568] font-light text-sm leading-relaxed mb-3">
            ...
            gespeichert. Hierbei kann es sich u. a. um IP-Adressen, Kontaktanfragen, Meta- und
            Kommunikationsdaten, Vertragsdaten und sonstige Daten handeln, die über eine Website
            generiert werden.
          </p>
          <p className="text-[#4a5568] font-light text-sm leading-relaxed mb-3">
            Unser Hoster ist: netcup GmbH, Emmy-Noether-Straße 10, D-76131 Karlsruhe.
          </p>

          <h2 className="font-serif text-xl text-[#1a3a5c] mt-8 mb-3">3. Erhebung und Speicherung personenbezogener Daten</h2>
          <p className="text-[#4a5568] font-light text-sm leading-relaxed mb-3">
          ...
          <h2 className="font-serif text-xl text-[#1a3a5c] mt-8 mb-3">4. Kontaktformular</h2>
          <p className="text-[#4a5568] font-light text-sm leading-relaxed mb-3">
          ...
          <h2 className="font-serif text-xl text-[#1a3a5c] mt-8 mb-3">5. Cookies</h2>
          <p className="text-[#4a5568] font-light text-sm leading-relaxed mb-3">
          ...
          <h2 className="font-serif text-xl text-[#1a3a5c] mt-8 mb-3">6. Ihre Rechte</h2>
          <p className="text-[#4a5568] font-light text-sm leading-relaxed mb-3">
          ...
          <h2 className="font-serif text-xl text-[#1a3a5c] mt-8 mb-3">7. Beschwerderecht</h2>
