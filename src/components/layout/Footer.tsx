      ...
      <div className="max-w-6xl mx-auto px-6 pt-14 pb-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
        <div>
          ...
          <p className="text-white/45 text-sm leading-relaxed">
            Ihr zuverlässiger Fachbetrieb für Heizung, Sanitär und Gebäudetechnik in [Region].
          </p>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-3">
            ...
            <li className="flex items-start gap-2 text-white/45 text-sm">
              ...
              <span>info@as-gebaeudetechnik.de</span>
            </li>
            <li className="flex items-start gap-2 text-white/45 text-sm">
              <MapPin className="h-4 w-4 text-[#e8621a] mt-0.5 flex-shrink-0" />
              <span>[Straße Nr.], [PLZ] [Stadt]</span>
            </li>
            <li className="text-white/45 text-sm pl-6">Mo–Fr: 7–18 Uhr</li>
          </ul>
        </div>
      </div>
