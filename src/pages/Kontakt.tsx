...
const hours = [
  ...
  { day: "Samstag", time: "08:00 – 13:00 Uhr" },
  { day: "Sonntag / Feiertag", time: "Notdienst auf Anfrage" },
];
  ...
  return (
    <div className="pt-24">
      ...
      <div className="max-w-6xl mx-auto px-6 py-16 grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
        ...
        >
          {[
            { Icon: Phone, label: "+49 XXX XXXXXXX", sub: "Direkter Anruf", href: "tel:+49XXXXXXXXX" },
            { Icon: Mail, label: "info@as-gebaeudetechnik.de", sub: "E-Mail senden", href: "mailto:info@as-gebaeudetechnik.de" },
            { Icon: MapPin, label: "[Straße Nr.], [PLZ] [Stadt]", sub: "Unser Standort", href: "#" },
          ...
          >
            ...
            <p className="text-xs opacity-60">[Straße Nr., PLZ Stadt]</p>
          </div>
        </motion.div>
