...
const usps = [
  ...
  { Icon: Wrench, title: "Meisterbetrieb", sub: "Staatlich zugelassener Fachbetrieb" },
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 py-24 w-full">
        <AnimatePresence initial={false} custom={dir} mode="wait">
          ...
          >
            ...
            >
              <StatItem target={25} suffix="+" label="Jahre Erfahrung" trigger={statsVisible} />
              <StatItem target={500} suffix="+" label="Zufriedene Kunden" trigger={statsVisible} />
              <div className="text-center sm:text-left">
    ...
    <div className="pt-24">
      ...
      <section ref={introRef} className="py-24 px-6">
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            >
              <strong className="block font-serif text-4xl leading-none">25+</strong>
              <span className="text-xs uppercase tracking-wider opacity-80">Jahre Erfahrung</span>
            </motion.div>
          </motion.div>
          ...
          >
            ...
            <p className="text-[#4a5568] font-light text-lg leading-relaxed mb-6">
              [Kurzer Einleitungstext über den Betrieb – was Sie auszeichnet, wie lange Sie in der
              Region tätig sind und was Ihnen wichtig ist.]
            </p>
            <ul className="space-y-3 mb-8">
              {[
                "Inhabergeführter Betrieb mit persönlichem Kontakt",
                "Langjährige Erfahrung in der Region",
                "Alle Arbeiten nach aktueller Norm & DVGW",
                "Sauber, pünktlich und termingerecht",
      ...
      <section className="bg-[#e8621a] py-8 px-6">
        <div className="max-w-6xl mx-auto flex flex-col sm:flex-row flex-wrap gap-6 items-start sm:items-center justify-between">
          {[
            { Icon: Phone, label: "+49 XXX XXXXXXX", sub: "Mo–Fr 7:00–18:00 · Sa 8:00–13:00" },
            { Icon: Mail, label: "info@as-gebaeudetechnik.de", sub: "Antwort innerhalb 24h" },
            { Icon: MapPin, label: "[Straße], [PLZ] [Stadt]", sub: "Servicegebiet: [Region]" },
          ].map(({ Icon, label, sub }) => (
