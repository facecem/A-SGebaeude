...
const team = [
  { initials: "AS", role: "Inhaber" },
  { initials: "MK", role: "Meister / Techniker" },
  { initials: "SB", role: "Büro / Verwaltung" },
];
      ...
      <div className="relative overflow-hidden py-20 px-6 text-center">
        ...
        >
          ...
          <p className="text-white/70 font-light text-lg max-w-xl mx-auto">
            Erfahrung, Verlässlichkeit und Leidenschaft für Gebäudetechnik – das ist A&S.
          </p>
        </motion.div>
      </div>
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <div className="inline-block bg-[#e8621a] text-white px-6 py-5 text-center mb-8">
              <strong className="block font-serif text-5xl leading-none">25+</strong>
              <small className="text-xs uppercase tracking-wider opacity-80">Jahre Erfahrung</small>
            </div>
            ...
            <h2 className="font-serif text-4xl text-[#1a3a5c] leading-tight mb-5">
              Inhabergeführt. Regional. Verlässlich.
            </h2>
            <p className="text-[#4a5568] font-light leading-relaxed mb-4">
              [Ihr Unternehmenstext: Gründungsgeschichte, Standort, Team, Werte. Wann wurde der
              Betrieb gegründet? Was macht Ihr Unternehmen aus? Was ist Ihnen besonders wichtig?]
            </p>
            <p className="text-[#4a5568] font-light leading-relaxed mb-8">
              Seit unserer Gründung stehen wir für Qualität, Transparenz und persönliche
              Betreuung. Als inhabergeführter Betrieb kennen wir unsere Kunden persönlich –
              und das ist uns wichtig.
            </p>
            <ul className="space-y-2 mb-8">
              {["Inhabergeführter Familienbetrieb", "DVGW-zertifizierter Fachbetrieb", "Staatlich anerkannter Meisterbetrieb", "Langjähriger Ansprechpartner in der Region"].map((item) => (
